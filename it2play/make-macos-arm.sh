...
clang -target arm64-apple-macos11 -mmacosx-version-min=11.0 -arch arm64 -march=armv8.3-a+sha3 -I/Library/Frameworks/SDL2.framework/Headers -F/Library/Frameworks -g0 -DNDEBUG -DAUDIODRIVER_SDL ../audiodrivers/sdl/*.c ../it2drivers/*.c ../loaders/mmcmp/*.c ../loaders/*.c ../*.c src/*.c -O3 -ffast-math -lm -Winit-self -Wno-deprecated -Wextra -Wunused -mno-ms-bitfields -Wno-missing-field-initializers -framework SDL2 -framework Cocoa -o release/other/it2play
